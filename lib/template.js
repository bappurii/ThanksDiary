...
module.exports ={
    template : function (ctg_list, ctg_UD, date, button, content) {
        ...
        return `
            ...
            <form action="/ctg/${req.params.ctg_id}/cont_deleting" method="post">
                    <input type="submit" value="category delete">
            </form>
        `
